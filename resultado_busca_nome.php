...
<body>
    ...
    <?php
        ...
        $nome_local = $_POST["local"] ?? '';

        $busca = "SELECT NOME, DESCRICAO, CIDADE, ESTADO, LONGADOURO, ID_POSTAGEM, EMAIL_CREATOR, PATH_IMAGEM FROM postagem as p WHERE NOME LIKE '%$nome_local%'";
    ...
    <?php
        while ($linha = mysqli_fetch_array($resultado)) {
            ...
            <div class='desc'>
                ...
                <a style='margin-left: 5px;' href='adiciona_postagem_nome.php?id=$id' class='btn btn-primary btn-sm'>Adicionar a lista de desejos</a>
            </div>
